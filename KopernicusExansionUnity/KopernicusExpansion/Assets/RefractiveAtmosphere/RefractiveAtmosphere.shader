 ...
 Shader "KopernicusExpansion/RefractiveAtmosphere" {
 Properties {
 ...
 half4 frag( v2f i ) : COLOR{
     ...
     half2 bump = UnpackNormal(tex2D( _BumpMap, i.uvbump + _BumpMapOffset.xy)).rg * _BumpMapOffset.z;
