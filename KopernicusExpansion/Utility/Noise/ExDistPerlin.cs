...
{
	public class ExDistPerlin : ModuleBase
	{
		public ExDistPerlin () : base(0)
		{
		...
		public double Mu
		{
			...
			{
				_mu = value;
				//recalculate magnitudes from new mu
				SetupMagnitudeTable ();
			}
		}
		...
		public override double GetValue (double x, double y, double z)
		{
			...
			for (var i = 0; i < _octaveCount; i++)
			{
				...
				var signal = GradientCoherentDistributedNoise3D (nx, ny, nz, seed, _quality);
				value += signal * cp;
				x *= _lacunarity;
				y *= _lacunarity;
				z *= _lacunarity;
