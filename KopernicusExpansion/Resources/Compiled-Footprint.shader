// Compiled shader for all platforms, uncompressed size: 214.4KB
...
SubShader { 
 ...
 //       d3d11 : 5 avg math (4..7), 1 avg texture (1..2)
 //    d3d11_9x : 5 avg math (4..7), 1 avg texture (1..2)
 //        d3d9 : 6 avg math (5..9), 1 avg texture (1..2)
 //      opengl : 7 avg math (6..9), 1 avg texture (1..2)
 Pass {
  Name "FORWARD"
...
void main ()
{
  ...
  tmpvar_5 = (c_3.w * _Opacity);
  tmpvar_2 = tmpvar_5;
  lowp vec4 c_6;
  c_6.xyz = ((_Color * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_6.w = tmpvar_2;
  c_1.xyz = (c_6.xyz + (_Color * xlv_TEXCOORD2));
  c_1.w = tmpvar_2;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_5 = (c_3.w * _Opacity);
  tmpvar_2 = tmpvar_5;
  c_1.xyz = (_Color * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = tmpvar_2;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = (_Color * ((8.0 * tmpvar_6.w) * tmpvar_6.xyz));
  c_1.w = tmpvar_2;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_5 = (c_3.w * _Opacity);
  tmpvar_2 = tmpvar_5;
  c_1.xyz = (_Color * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = tmpvar_2;
  _glesFragData[0] = c_1;
}
...
MUL R1.xyz, fragment.texcoord[2], c[3];
MUL R0.xyz, R0, c[3];
MAX R1.w, R1, c[4].x;
MUL R0.xyz, R1.w, R0;
...
BindCB  "UnityLighting" 1
"ps_4_0
eefiecedlgljdjdlmnpiipleanpnjglllmapfnfnabaaaaaaheacaaaaadaaaaaa
...
aaaaaaaadiaaaaajocaabaaaaaaaaaaaagijcaaaaaaaaaaaabaaaaaafgiocaaa
aaaaaaaaadaaaaaadiaaaaaihcaabaaaabaaaaaaegbcbaaaadaaaaaajgihcaaa
...
BindCB  "UnityLighting" 1
"ps_4_0_level_9_1
eefiecednbiaellcjoecjkkbpakgolnijklijlmiabaaaaaaniadaaaaaeaaaaaa
daaaaaaajaabaaaabmadaaaakeadaaaaebgpgodjfiabaaaafiabaaaaaaacpppp
amabaaaaemaaaaaaadaaciaaaaaaemaaaaaaemaaabaaceaaaaaaemaaaaaaaaaa
...

...
abaaaaaafgiocaaaaaaaaaaaadaaaaaadiaaaaaihcaabaaaabaaaaaaegbcbaaa
adaaaaaajgihcaaaaaaaaaaaadaaaaaadcaaaaajhccabaaaaaaaaaaajgahbaaa
...
aaaaaaaadkaabaaaaaaaaaaaakiacaaaaaaaaaaaadaaaaaadoaaaaabejfdeheo
...
adaaaaaaacaaahacacaaaaoeaeaaaaaaadaaaaoeabaaaaaa mul r2.xyz, v2, c3
...
adaaaaaaaaaaaiacaaaaaappacaaaaaaacaaaaaaabaaaaaa mul r0.w, r0.w, c2.x
...
BindCB  "$Globals" 0
"ps_4_0
eefiecednicllfhehemmhknlggmphgehmgcgcoidabaaaaaabiacaaaaadaaaaaa
...
aaaaaaaajgihcaaaaaaaaaaaadaaaaaaefaaaaajpcaabaaaaaaaaaaaegbabaaa
abaaaaaaeghobaaaaaaaaaaaaagabaaaaaaaaaaadiaaaaaiiccabaaaaaaaaaaa
dkaabaaaaaaaaaaaakiacaaaaaaaaaaaadaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
// Stats: 4 math, 2 textures
Keywords { "DIRECTIONAL" "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" }
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedphlpjhlilnhbkhkgdjoaacplipmjcjpeabaaaaaaciadaaaaaeaaaaaa
daaaaaaadmabaaaaieacaaaapeacaaaaebgpgodjaeabaaaaaeabaaaaaaacpppp
...
acaacdiaaaaaoeiaaaaamjkaafaaaaadacaaceiaaaaakkiaaaaappkaafaaaaad
acaaciiaabaappiaaaaaaakaabaaaaacaaaicpiaacaaoeiappppaaaafdeieefc
eaabaaaaeaaaaaaafaaaaaaafjaaaaaeegiocaaaaaaaaaaaaeaaaaaafkaaaaad
...
hccabaaaaaaaaaaaegacbaaaaaaaaaaajgihcaaaaaaaaaaaadaaaaaaefaaaaaj
pcaabaaaaaaaaaaaegbabaaaabaaaaaaeghobaaaaaaaaaaaaagabaaaaaaaaaaa
diaaaaaiiccabaaaaaaaaaaadkaabaaaaaaaaaaaakiacaaaaaaaaaaaadaaaaaa
...
void main ()
{
  ...
  lowp vec4 c_9;
  c_9.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_8)).w) * 2.0));
  c_9.w = tmpvar_3;
  c_1.xyz = c_9.xyz;
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_9;
  c_9.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture (_LightTexture0, vec2(tmpvar_8)).w) * 2.0));
  c_9.w = tmpvar_3;
  c_1.xyz = c_9.xyz;
  c_1.w = tmpvar_3;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = ((_Color * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_7.w = tmpvar_3;
  c_1.xyz = c_7.xyz;
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_10) * 2.0));
  c_11.w = tmpvar_3;
  c_1.xyz = c_11.xyz;
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_9;
  c_9.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_9.w = tmpvar_3;
  c_1.xyz = c_9.xyz;
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_9;
  c_9.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture (_LightTextureB0, vec2(tmpvar_8)).w * texture (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_9.w = tmpvar_3;
  c_1.xyz = c_9.xyz;
  c_1.w = tmpvar_3;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_7;
  c_7.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_7.w = tmpvar_3;
  c_1.xyz = c_7.xyz;
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_7;
  c_7.xyz = ((_Color * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_7.w = tmpvar_3;
  c_1.xyz = c_7.xyz;
  c_1.w = tmpvar_3;
  _glesFragData[0] = c_1;
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedfihjnfegnigiiobkbfonfbfabnkcpiooabaaaaaaaeadaaaaadaaaaaa
...
fdeieefcpmabaaaaeaaaaaaahpaaaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaa
...
ocaabaaaaaaaaaaaagijcaaaaaaaaaaaabaaaaaafgiocaaaaaaaaaaaahaaaaaa
...
diaaaaaiiccabaaaaaaaaaaadkaabaaaaaaaaaaaakiacaaaaaaaaaaaahaaaaaa
doaaaaab"
}
SubProgram "d3d11_9x " {
// Stats: 10 math, 2 textures
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedfcbfbaededfbjbpmlgblankeloinlodcabaaaaaakaaeaaaaaeaaaaaa
daaaaaaamiabaaaammadaaaagmaeaaaaebgpgodjjaabaaaajaabaaaaaaacpppp
...

...
abaaaaaadiaaaaajocaabaaaaaaaaaaaagijcaaaaaaaaaaaabaaaaaafgiocaaa
...

...
adaaaaaaaaaaaiacabaaaappacaaaaaaabaaaaaaabaaaaaa mul r0.w, r1.w, c1.x
aaaaaaaaaaaaapadaaaaaaoeacaaaaaaaaaaaaaaaaaaaaaa mov o0, r0
"
}
SubProgram "glesdesktop " {
...
BindCB  "$Globals" 0
"ps_4_0

...
aaaaaaaaabaaaaaafgiocaaaaaaaaaaaadaaaaaadiaaaaahhccabaaaaaaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedcncahikkleioelefgacjijimpgmaidldabaaaaaahiadaaaaaeaaaaaa
daaaaaaagmabaaaalmacaaaaeeadaaaaebgpgodjdeabaaaadeabaaaaaaacpppp
...

...
agijcaaaaaaaaaaaabaaaaaafgiocaaaaaaaaaaaadaaaaaadiaaaaahhccabaaa
...
adaaaaaaaaaaahacaaaaaaaaacaaaaaaabaaaakeacaaaaaa mul r0.xyz, r0.x, r1.xyzz
adaaaaaaaaaaahacaaaaaakeacaaaaaaadaaaaffabaaaaaa mul r0.xyz, r0.xyzz, c3.y
adaaaaaaaaaaaiacaaaaaappacaaaaaaabaaaaaaabaaaaaa mul r0.w, r0.w, c1.x
aaaaaaaaaaaaapadaaaaaaoeacaaaaaaaaaaaaaaaaaaaaaa mov o0, r0
"
}
SubProgram "glesdesktop " {
...
BindCB  "$Globals" 0
"ps_4_0

...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefcpaacaaaaeaaaaaaalmaaaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaa
...
aaaaaaaaabaaaaaafgiocaaaaaaaaaaaahaaaaaadiaaaaahhccabaaaaaaaaaaa
agaabaaaaaaaaaaajgahbaaaaaaaaaaaefaaaaajpcaabaaaaaaaaaaaegbabaaa
abaaaaaaeghobaaaaaaaaaaaaagabaaaacaaaaaadiaaaaaiiccabaaaaaaaaaaa
dkaabaaaaaaaaaaaakiacaaaaaaaaaaaahaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
// Stats: 16 math, 3 textures
Keywords { "SPOT" }
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedjkjcefoknbalonnekdebmjidlaiodolgabaaaaaapeafaaaaaeaaaaaa
daaaaaaaciacaaaacaafaaaamaafaaaaebgpgodjpaabaaaapaabaaaaaaacpppp
...

...
aaaaaaaaagijcaaaaaaaaaaaabaaaaaafgiocaaaaaaaaaaaahaaaaaadiaaaaah
...
iccabaaaaaaaaaaadkaabaaaaaaaaaaaakiacaaaaaaaaaaaahaaaaaadoaaaaab
...
adaaaaaaacaaadacadaaaaoeaeaaaaaaaaaaaaaaacaaaaaa mul r2.xy, v3, r0.x
...
ckaaaaaaaaaaabacadaaaakkacaaaaaaadaaaaffabaaaaaa slt r0.x, r3.z, c3.y
...
TEMP R2;
TEX R0.w, fragment.texcoord[0], texture[0], 2D;
TEX R2.w, fragment.texcoord[3], texture[2], CUBE;
DP3 R0.x, fragment.texcoord[3], fragment.texcoord[3];
MUL result.color.w, R0, c[1].x;
TEX R1.w, R0.x, texture[1], 2D;
DP3 R0.x, fragment.texcoord[2], fragment.texcoord[2];
...
BindCB  "$Globals" 0
"ps_4_0

...

...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedioikbleaffpbljbgglfhhmpcmbbihjoiabaaaaaaciafaaaaaeaaaaaa
daaaaaaapeabaaaafeaeaaaapeaeaaaaebgpgodjlmabaaaalmabaaaaaaacpppp
...

...

...
adaaaaaaabaaahacabaaaaaaacaaaaaaacaaaaoeaeaaaaaa mul r1.xyz, r1.x, v2
bcaaaaaaabaaabacabaaaaoeaeaaaaaaabaaaakeacaaaaaa dp3 r1.x, v1, r1.xyzz
adaaaaaaaaaaabacacaaaappacaaaaaaabaaaappacaaaaaa mul r0.x, r2.w, r1.w
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedbpfigjjbgeagfapkbplpkghdoodoldioabaaaaaajmacaaaaadaaaaaa
cmaaaaaammaaaaaaaaabaaaaejfdeheojiaaaaaaafaaaaaaaiaaaaaaiaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaimaaaaaaaaaaaaaaaaaaaaaa
...

...
agijcaaaaaaaaaaaabaaaaaafgiocaaaaaaaaaaaahaaaaaadiaaaaahhccabaaa
aaaaaaaaagaabaaaaaaaaaaajgahbaaaaaaaaaaaefaaaaajpcaabaaaaaaaaaaa
egbabaaaabaaaaaaeghobaaaaaaaaaaaaagabaaaabaaaaaadiaaaaaiiccabaaa
aaaaaaaadkaabaaaaaaaaaaaakiacaaaaaaaaaaaahaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
// Stats: 6 math, 2 textures
Keywords { "DIRECTIONAL_COOKIE" }
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedmggaldhhoaiiaigleebbfmnkldikpdooabaaaaaabmaeaaaaaeaaaaaa
daaaaaaakmabaaaaeiadaaaaoiadaaaaebgpgodjheabaaaaheabaaaaaaacpppp
...
acaaaaadaaaacbiaaaaaaaiaaaaaaaiaabaaaaacaaaaaoiaabaaoekaafaaaaad
abaacdiaaaaamjiaaaaaoekaafaaaaadabaaceiaaaaappiaaaaakkkaafaaaaad
aaaachiaaaaaaaiaabaaoeiaafaaaaadaaaaciiaabaappiaabaaaakaabaaaaac
...

